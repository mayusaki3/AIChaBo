# -*- coding: utf-8 -*-
"""
M02:T01-01 Provider 正規化・表示名テスト
目的:
...
出力:
  ✅/❌ と [M02:T01-01-xx] を先頭に持つ行 + SUMMARY（共通レポータ）
"""
...
if __name__ == "__main__":
    ...
    mapping = {
        "test_01_normalize_known":  ("M02:T01-01-01", "normalize known"),
        "test_02_normalize_unknown":("M02:T01-01-02", "normalize unknown"),
        "test_03_display_names":    ("M02:T01-01-03", "display names"),
