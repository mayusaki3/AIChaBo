# -*- coding: utf-8 -*-
"""
COMMON-CHAT:T01-01 Provider 正規化・表示名テスト
目的:
...
出力:
  ✅/❌ と [COMMON-CHAT:T01-01-xx] を先頭に持つ行 + SUMMARY（共通レポータ）
"""
...
class ProviderTest(unittest.TestCase):
    ...
    # [COMMON-CHAT:T01-01-01] 既知名称/エイリアスの正規化:
...
if __name__ == "__main__":
    ...
    mapping = {
        "test_01_normalize_known":  ("COMMON-CHAT:T01-01-01", "normalize known"),
        "test_02_normalize_unknown":("COMMON-CHAT:T01-01-02", "normalize unknown"),
        "test_03_display_names":    ("COMMON-CHAT:T01-01-03", "display names"),
        "test_04_display_empty":    ("COMMON-CHAT:T01-01-04", "display empty"),
    }
    suite = unittest.defaultTestLoader.loadTestsFromTestCase(ProviderTest)
    run_unittest_suite("COMMON-CHAT:T01-01 common/chat/provider", suite, mapping)
