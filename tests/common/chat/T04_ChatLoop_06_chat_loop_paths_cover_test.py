# -*- coding: utf-8 -*-
"""
T05-06 : ChatLoop ルート網羅（helpers/normalize/dispatch 仕上げ）

対象: common/chat/chat_loop.py

目的:
  - T05-01〜05 で未到達だった「方針解決〜実行」の軽微な分岐を最小入力でカバーする。
...
class ChatLoopPathsCoverTest(unittest.TestCase):
    ...
    既存 T05-01..05 と重複しないよう、以下にフォーカスする:
      - final_model の決定ロジック
      - 応答型/内容に応じた整形
