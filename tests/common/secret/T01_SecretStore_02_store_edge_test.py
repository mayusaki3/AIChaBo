...
mapping = {
    "test_01_put_user_empty_provider_raises":
        ("COMMON-SECRET:T01-02-01", "put_user: provider空 -> ValueError"),
    "test_02_put_server_empty_provider_raises":
        ("COMMON-SECRET:T01-02-02", "put_server: provider空 -> ValueError"),
    "test_03_get_user_empty_provider_returns_none":
        ("COMMON-SECRET:T01-02-03", "get_user: provider空 -> None"),
    "test_04_get_server_empty_provider_returns_none":
        ("COMMON-SECRET:T01-02-04", "get_server: provider空 -> None"),
    "test_05_has_server_any_key_false_then_true":
        ("COMMON-SECRET:T01-02-05", "has_server_any_key False/True"),
    "test_06_delete_server_keys_safe_when_no_entry":
        ("COMMON-SECRET:T01-02-06", "delete_server_keys 安全"),
    "test_07_backward_compat_no_prefix":
        ("COMMON-SECRET:T01-02-07", "旧prefixなし互換"),
    "test_08_broken_json_is_recovered_to_empty":
        ("COMMON-SECRET:T01-02-08", "壊れJSON復旧"),
    "test_09_delete_user_keys_clears_all":
        ("COMMON-SECRET:T01-02-09", "delete_user_keys 全削除"),
}


if __name__ == "__main__":
    suite = unittest.defaultTestLoader.loadTestsFromTestCase(SecretStoreEdgesRecoveryTest)
    run_unittest_suite("COMMON-SECRET:T01-02 common/secret/store", suite, mapping)
